...
public class SShopController extends BaseController{
	...
	@ResponseBody
	public JSONObject addOneShop(String name, @RequestParam("sBossId")int sBossId, String dq,@RequestParam("style")int style){
		return this.shopService.addOneShop(name,sBossId,dq,style);
	}
